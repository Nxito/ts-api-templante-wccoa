...
router.use('/latest', swaggerUi.serve, (req, res, next) => swaggerUi.setup(swaggerDocument)(req, res, next));
router.use('/v1', swaggerUi.serve, (req, res, next) => swaggerUi.setup(swaggerDocument)(req, res, next));
router.use('/v2', swaggerUi.serve, (req, res, next) => swaggerUi.setup(swaggerDocument_v2)(req, res, next));
