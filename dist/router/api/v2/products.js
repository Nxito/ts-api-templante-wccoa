...
const areFruits = (data) => {
    if (data.every(item => typeof item.id === 'number' && typeof item.name === 'string')) {
        return true;
    }
    return false;
};
let data = [{ id: 1, name: 'Tomate' }, { id: 2, name: 'Sandía' }];
function maxId(params) {
